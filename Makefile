...
.PHONY: help build test vet run deploy deploy-build oric-client
...
help: ## Affiche cette aide
	...
	@echo "  make oric-client   Construit la .tap du terminal Oric"
...
oric-client: ## Construit la .tap du terminal Oric
